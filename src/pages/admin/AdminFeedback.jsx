...
export default function AdminFeedback() {
    ...
    const renderAnalytics = () => {
        ...
        const byRoleData = [
            { label: "Students", value: (summary?.by_role?.student || summary?.by_role?.STUDENT || summary?.by_role?.Student || 0), color: ROLE_COLORS.student },
            { label: "Managers", value: (summary?.by_role?.manager || summary?.by_role?.MANAGER || summary?.by_role?.Manager || 0), color: ROLE_COLORS.manager },
            { label: "Principals", value: (summary?.by_role?.principal || summary?.by_role?.PRINCIPAL || summary?.by_role?.Principal || 0), color: ROLE_COLORS.principal },
        ];
