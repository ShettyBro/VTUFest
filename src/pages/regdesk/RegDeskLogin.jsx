    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (data.data?.status === "FORCE_RESET") {
                ...
                localStorage.setItem("force_reset_portal", "reg");
            ...
            // Normal login
            localStorage.setItem("vtufest_regdesk_token", data.data.token);
            localStorage.setItem("vtufest_regdesk_name", data.data.name);
            localStorage.setItem("vtufest_regdesk_role", "REG_DESK_HEAD");
            navigate("/reg-dashboard");
        } catch (err) {
            ...
            <div className="auth-container">
                ...
                <div className="auth-info-panel">
                    ...
                    <div style={{ marginTop: "30px", color: "rgba(255,255,255,0.8)", fontSize: "0.9rem", textAlign: "center" }}>
                        <p>Registration Desk Head Portal</p>
                        <p style={{ fontSize: "0.8rem", marginTop: "6px", color: "rgba(255,255,255,0.5)" }}>Restricted access — authorized personnel only</p>
                    </div>
                </div>
                ...
                <div className="auth-form-panel">
                    ...
                    <form className="auth-form" onSubmit={handleLogin}>
                        <h2 className="form-title">Registration Desk Login</h2>

                        <div style={{
                            textAlign: "center", marginBottom: "20px", padding: "10px 16px",
                            background: "rgba(16,185,129,0.08)", borderRadius: "10px",
                            border: "1px solid rgba(16,185,129,0.2)", fontSize: "0.82rem",
                            color: "rgba(16,185,129,0.9)", fontWeight: 600, letterSpacing: "0.03em"
                        }}>
                            📋 Head of Registration Desk Portal
                        </div>
