...
const EventManagerFind = () => {
    ...
    const handleSearchPerson = async (e) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/api/event-manager/find/person`, {
                method: "POST",
                headers: {
    ...
    const handleSearchCollege = async (e) => {
        ...
        try {
            const response = await fetch(`${API_BASE}/api/event-manager/find/college`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`
...
export default EventManagerFind;
